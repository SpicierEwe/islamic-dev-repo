        ...
        {data.map((item, index) => {
          <div className={styles.content}>
            <div className={styles.content_header}>
              <h2 className={`${styles.title} ${styles.old}`}>{item.old}</h2>
            ...
            <p className={styles.description}>
              This will be the definition of the title. lorem ipsum dolor sit
              amet, consectetur adipiscing elit. Nulla facilisi. Sed euismod,
              nisl vel tincidunt aliquam, nisl nisl fermentum massa, nec luctus
              nunc ante ut dui. Nulla facilisi. Sed
            </p>
