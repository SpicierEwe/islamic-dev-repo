                  ...
                  return (
                    <li
                      ...
                      onClick={() => {
                        ...
                        setSelectedTab(Object.keys(data));
                      }}
                    >
                      <p>
                ...
                <ul key={index} className={styles.items_container}>
                  {
                    ...
                    data[Object.keys(data)].map((finalData, index) => {
                      if (Object.keys(data) == selectedTab) {
                        return (
                          <li key={index}>
                            {/* item image */}
                          ...
                          ></MdDownloadForOffline> */}
                            ...
                            <div>
                              ...
                              <ul className={styles.included_chip_container}>
                                {finalData[Object.keys(finalData)].includes.map(
                                  (included, index) => {
                                    return (
                                      <li
                                        key={index}
                            ...
                            <p className={styles.item_description}>
                              {finalData[Object.keys(finalData)]["description"]}
                            </p>
                          </li>
                        );
                      }
