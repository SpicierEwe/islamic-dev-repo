                              ...
                              <li key={index}>
                                ...
                                <div className={styles.flex_intro}>
                                  ...
                                  <div className={styles.interactive_buttons}>
                                    ...
                                    <Image
                                      id={`download_button_id_${index}`} download={"download"}
                                      onClick={(e) => {
...
function generateLinks(button_id) {
  if (document.getElementById(button_id.toString()).src == "") {
    console.log("this is the link generator");

    var formBlob = new Blob(["msdsdmklmdlmsdlm"], { type: "text/plain" });
    const url = window.URL.createObjectURL(formBlob);

    document.getElementById(button_id.toString()).href = url;
    document.getElementById(button_id.toString()).download = ;
  }
}
