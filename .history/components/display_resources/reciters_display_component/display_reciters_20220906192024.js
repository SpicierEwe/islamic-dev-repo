...
async function generateLinks(generatable_link_template, reciter_name) {
  ...
  const generatedUrls = await (await res.json()).generated_urls_array;
  var hiddenElement = document.createElement("a");

  console.log(generatedUrls);
  hiddenElement.href = "data:attachment/text," + JSON.stringify(generatedUrls);
  hiddenElement.target = "_blank";
  hiddenElement.download = `${reciter_name}.json`;
  hiddenElement.click();
}
