                            ...
                            <div className={styles.flex_intro}>
                              ...
                              <div className={styles.item_title_container}>
                                ...
                                <p className={styles.item_title}>
                                  {/* if the main key is tranaltions then show item title = subtitle cause subtitle has the translation name and the main title has the author name and translation name should be visible 1st*/}
