...
export default function DisplayDownloadable(props) {
  ...
  function languageTranslationsDownloadButton(data, index) {
    function downlaoder() {
      var zip = JSZip();
      var count = 0;
      var zipFilename = "zipFileeName.zip";

      var urls = [
        "https://cors-tanzil.net/trans/?transID=sq.nahi&type=txt",
        "https://cors-tanzil.net/trans/?transID=ar.jalalayn&type=txt",
        "https://cors-tanzil.net/trans/?transID=en.transliteration&type=txt",
      ];
