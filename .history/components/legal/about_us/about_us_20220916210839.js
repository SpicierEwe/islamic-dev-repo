      ...
      >
        ...
        <div className={styles.resourcer_container}>
          ...
          <div className={styles.work_container}>
            ...
            <ul>
              <li>
                <Link href={"https://quran.com/"}> Quran.com</Link>
              </li>
              <li>
                {" "}
          ...
          <p className={styles.resourcer_description}>
            ...
            the authentic islamic data with us. And we pray to Allah that he may
            accept him efforts and reward him with the best of rewards.
          </p>
        </div>
      </div>
    </div>
