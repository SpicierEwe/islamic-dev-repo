    ...
    <div className={styles.bg}>
      ...
      <div className={styles.container_development}>
        <p>
          ...
          reason behind the development of this website. Yes you can find a lot
          of resources on the internet but only some of them are authentic or
          lacking optimization. The data provided in this website is collected
          from the most authentic sources. So Alahmadullilah you font have to
