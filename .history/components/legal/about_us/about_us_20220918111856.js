    ...
    <div className={styles.bg}>
      ...
      <div className={styles.container_development}>
        <p className={styles.summary}>
          ...
          don&apos;t have to worry about the authenticity of the data. But we
          all are humans and we can make mistakes. So if you find any mistake in
          the data please let us know. We will be very thankful to you.
          Jazak&apos;Allahu khair!
        </p>
      </div>
