      ...
      >
        ...
        <div className={styles.resourcer_container}>
          ...
          <p className={styles.resourcer_description}>
            Our Brother Ayman Siddiqui helped us alot by sharing the authentic
            islamic data with us. And we pray to Allah (swt) that he may accept
            his efforts and reward him with the best of rewards.
          </p>
        </div>
      </div>
    </div>
