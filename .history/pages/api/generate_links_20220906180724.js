export default async function handler(req, res) {
    ...
    const url_template = req.body.url_template;
    const reciter_name = req.body.reciter_name;
  console.log(req.body);
  const generateLinks = [];
  for(var x = 0 ; x < quranMedaData.length ; x++){

    for (var ayahNumber in quranMedaData[x][1].ayahs) {
            generateLinks.push(
                `${url_template}/${reciter_name}/${quranMedaData[x][1].surah_number}/${ayahNumber}.mp3`
            )
